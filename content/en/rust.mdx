...
The Rust SDK is async, type-safe, and built on `tokio` + `reqwest` + `serde`. **51 tests**. All protocol types derive `Serialize + Deserialize + Clone + Debug`. Tested on Linux, macOS, and Windows.
